package com.benchmark.javaScala.generated;
...
import com.benchmark.javaScala.generated.App_jmhType;
import com.benchmark.javaScala.generated.SomeState_jmhType;
public final class App_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            SomeState_jmhType l_somestate1_G = _jmh_tryInit_f_somestate1_G(control);
            ...
            while (control.warmupShouldWait) {
                l_app0_0.testMethod(l_somestate1_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_somestate1_G, l_app0_0);
            ...
            if (control.isLastIteration()) {
                if (SomeState_jmhType.tearTrialMutexUpdater.compareAndSet(l_somestate1_G, 0, 1)) {
                    try {
                        if (control.isFailing) throw new FailureAssistException();
                        if (l_somestate1_G.readyTrial) {
                            l_somestate1_G.readyTrial = false;
                        }
                    } catch (Throwable t) {
                        control.isFailing = true;
                        throw t;
                    } finally {
                        SomeState_jmhType.tearTrialMutexUpdater.set(l_somestate1_G, 0);
                    }
                } else {
                    long l_somestate1_G_backoff = 1;
                    while (SomeState_jmhType.tearTrialMutexUpdater.get(l_somestate1_G) == 1) {
                        TimeUnit.MILLISECONDS.sleep(l_somestate1_G_backoff);
                        l_somestate1_G_backoff = Math.max(1024, l_somestate1_G_backoff * 2);
                        if (control.isFailing) throw new FailureAssistException();
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_somestate1_G, l_app0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_somestate1_G, l_app0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, SomeState_jmhType l_somestate1_G, App_jmhType l_app0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_somestate1_G, l_app0_0);
            control.preTearDown();
    ...
    static volatile SomeState_jmhType f_somestate1_G;
    
    SomeState_jmhType _jmh_tryInit_f_somestate1_G(InfraControl control) throws Throwable {
        SomeState_jmhType val = f_somestate1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
